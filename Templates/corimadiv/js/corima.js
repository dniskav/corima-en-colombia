...
arboles[1]="1 -	�rbol de Manzana";
arboles[2]="2 -	�rbol del Cacao";
arboles[3]="3 -	�rbol del Cipr�s";
arboles[4]="4 -	�rbol del Almendro";
arboles[5]="5 -	�rbol del Cedro";
arboles[6]="6 -	�rbol del Durazno";
arboles[7]="7 -	�rbol Jazm�n del Cabo";
arboles[8]="8 -	�rbol del Nogal";
arboles[9]="9 -	�rbol de la Acacia";
arboles[10]="10 -	�rbol de Pino";
arboles[11]="11 -	�rbol del Olivo";
arboles[12]="12 -	�rbol del Caucho";
arboles[13]="13 -	�rbol del Ciruelo";
arboles[14]="14 -	�rbol del Sauce";
arboles[15]="15 -	�rbol de Alcaparro";
arboles[16]="16 -	�rbol de Roble";
arboles[17]="17 -	�rbol del Cerezo";
arboles[18]="18 -	�rbol de la Guayaba";
arboles[19]="19 -	�rbol de Sauco";
arboles[20]="20 -	�rbol de Madro�o";
arboles[21]="21 -	�rbol de Zapote";
arboles[22]="22 -	�rbol de Aguacate";
arboles[23]="23 -	�rbol de la Guama";
arboles[24]="24 -	�rbol del Guayac�n";
arboles[25]="25 -	�rbol de Lima";
arboles[26]="26 -	�rbol del Eucalipto";
arboles[27]="27 -	�rbol del Lim�n";
arboles[28]="28 -	�rbol de Naranja";
arboles[29]="29 -	�rbol del Mango";
arboles[30]="30 -	�rbol de Mandarina";
arboles[31]="31 -	�rbol de Breva";
...
frutos[1]="1� =	Enero las uvas";
frutos[2]="2� =	Febrero el banano";
frutos[3]="3� =	Marzo las fresas";
frutos[4]="4� =	Abril las moras";
frutos[5]="5� =	Mayo la guan�bana";
frutos[6]="6� =	Junio la pera";
frutos[7]="7� =	Julio la sandia";
frutos[8]="8� =	Agosto el lulo";
frutos[9]="9� =	Septiembre el coco";
frutos[10]="10� =	Octubre la pi�a";
frutos[11]="11� =	Noviembre el Kiwi";
frutos[12]="12� = Diciembre  las cerezas";
...
function nostradamus(){
	LanzaCarta(barajaNtradame);
}

function cjesus(){
	LanzaCarta(cjesus_Imagenes);
}
...
function xgrama(codigo){
	...
	finalgrap.value=totalgrap.value;
	if (i<=0){
		alert("tu nombre no es v�lido. intentalo de nuevo "+ i )
		return ""
		}
	}
